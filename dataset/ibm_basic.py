...
class IBMBasicDataset(Dataset):
    """
    This class is the parent class for all method-specified IBM dataset classes
    """
    def __init__(self,
                 cls_task,
                 user_ids=None,
        ...
        self.root = root
        self.fname = fname
        self.user_level_cached = False #user_level_cached
        self.vocab_cached = False #vocab_cached
