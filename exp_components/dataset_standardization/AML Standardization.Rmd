...
transactionsOriginal <- read_rds("/data/IDEA_DeFi_Research/Data/AML/LI_Small/transactionsOriginal.rds")
```
...
saveRDS(transactionsStandardized, file="/data/IDEA_DeFi_Research/Data/AML/LI_Small/transactions_user_time.rds")
```